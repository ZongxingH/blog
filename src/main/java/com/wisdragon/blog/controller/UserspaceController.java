...
public class UserspaceController {
	...
	public String listBlogsByOrder(@PathVariable("username") String username,
		...
		if (catalogId != null && catalogId > 0) { // 分类查询
			Optional<Blog_Catalog> optionalCatalog = catalogService.getCatalogById(catalogId);
	...
	public String getBlogById(@PathVariable("username") String username, @PathVariable("id") Long id, Model model) {
		...
		if (SecurityContextHolder.getContext().getAuthentication() != null
			...
			principal = (Sys_User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
		...
		// 判断操作用户的点赞情况
		List<Blog_Vote> votes = blog.getVotes();
		Blog_Vote currentVote = null; // 当前用户的点赞情况
		
		if (principal !=null) {
			for (Blog_Vote vote : votes) {
	...
	@PreAuthorize("authentication.name.equals(#username)")
	public String saveProfile(@PathVariable("username") String username, Sys_User user) {
		Sys_User originalUser = userService.getUserById(user.getId()).get();
	...
	@PreAuthorize("authentication.name.equals(#username)")
	public ResponseEntity<Response> saveAvatar(@PathVariable("username") String username, @RequestBody Sys_User user) {
